    ...
    <div class="content-wrapper">
        <div class="content-body">
            ...
            <?php  
                ...
                $cour = mysqli_query($link, $sqlco);
                while ($co_data =  mysqli_fetch_array($cour)) {
                ...
                <section class="users-list-wrapper">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <?php
                                if($cou==1){?>
                                    <h4 class="card-title">الفصل الاول</h4>
                               <?php }
                               else
                               {?>
                                    <h4 class="card-title">الفصل الثاني</h4>
                               <?php
                               }
                            ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    $sql = "SELECT materials.AName as name , finaldegree.Degree as Fdegree
                                                        ,pursuitdegree.Degree as Mdegree
                                                            ...
                                                            where Department_Id = $depn && Level_Id =$stg && Course_Id=$cou";
                    ...
                    <div class="add-new-data">
                        ...
                        <div class="add-data-footer d-flex justify-content-around px-3 mt-2">
                            <div class="cancel-data-btn ">
                                <a href="printcertificateAll.php?id=<?php echo $_GET['id']; ?>" class="btn btn-danger">
