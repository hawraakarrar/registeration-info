            ...
            if ($isUploaded) {
                ...
                foreach ($records as $row) {
                    ...
                    include("../connect.php");
                            ...
                            $round = $link->real_escape_string($_POST['RoundID']);
                            echo $year;
                            ...
                            $query = "INSERT INTO finaldegree (Degree,Material_Id,Student_Id,Round_Id) 
                    		values('$Degree',' $material' ,'" . $stu_data['ID'] . "' ,'$round'  )";
