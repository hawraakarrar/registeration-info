                        ...
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li><a href="exportmiddegree.php?id=<?php echo $_GET['id'] ?>"><i class="fa fa-file-excel-o"></i></a></li>
                            ...
                            <div class="table-responsive">
                                <table class="tablesorter table">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT pursuitdegree.Degree as degree, students.Name as name
                                        FROM pursuitdegree
                                        INNER JOIN students ON pursuitdegree.Student_Id=students.ID where Material_Id=" . $_GET['id'];
